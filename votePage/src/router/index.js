...
const globalRoutes = [
  ...
  {
    path: '/detail',
    component: _import('modules/detail/detail'),
    name: 'detail',
    meta: { title: '详情' }
  },
  {
    path: '/allList',
    component: _import('modules/allList/allList'),
    name: 'allList',
    meta: { title: '作品列表' }
  }
]
...
const mainRoutes = {
  ...
  children: [
    ...
    {
      path: '/opus-manage',
      component: _import('modules/manage/opusManage'),
      name: 'opus-manage',
      meta: { title: '作品管理', isTab: true }
    },
    {
      path: '/news-manage',
      component: _import('modules/manage/newsManage'),
      name: 'news-manage',
      meta: { title: '新闻管理', isTab: true }
    },
    // { path: '/rule', component: _import('common/rule'), name: 'rule', meta: { title: '规则' } },
    {
      path: '/theme',
